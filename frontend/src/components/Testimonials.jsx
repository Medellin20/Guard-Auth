  ...
  return (
    <div className={`${styles.paddingY} flex flex-col font-poppins text-white gap-10`} >
      <div className='flex xs:flex-col xs:gap-5 ss:text-left ss:flex-row justify-center items-center text-center gap-0'>
        <h1 className={`${styles.heading2} ss:max-w-[50%] ss:w-[450px]`} data-aos="fade-right" data-aos-duration="1000">Ce que <span className='text-gradient'>les gens</span> disent de faire </h1>
        <p className={`${styles.paragraph} ss:max-w-[50%] ss:w-[460px] justify-center`} data-aos="fade-left" data-aos-duration="1000"></p>
      </div>
