...
const publishingOptions = [
  ...
  { title: 'Particulier', current: true },
  { title: 'Entreprise', current: false },
]

const publishingOptions_ = [

  { title: 'Soumetteur', current: true },
  { title: 'Financeur', current: false },
]
...
const SignUp = () => {
  ...
  const [userStatus, setUserStatus] = useState(publishingOptions_[0])
  ...
  const handleSignup = async (e) => {
    ...
    if (name.length <1 || name.length >20) {
      return (
          alert ("The name must be between 1 and 20 characters!")
      );
    }
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <h2 className="mb-9 text-2xl font-bold text-center text-indigo-600 dark:text-white sm:text-title-xl2">
                Inscrivez-vous 
              </h2>
              ...
              <form method='POST' onSubmit={handleSignup}>
                ...
                <div className="mb-6 py-2 flex justify-between">
                  <div>
                    <Listbox value={userType} onChange={setUserType}>
                      {({ open }) => (
                        <>
                          <div className="relative py-2">
                            <div className="inline-flex divide-x divide-indigo-700 rounded-md shadow-sm bg-primary">
                              <div className="inline-flex items-center gap-x-1.5 rounded-l-md bg-indigo-600 px-3 py-2 text-white shadow-sm">
                                <CheckIcon className="-ml-0.5 h-5 w-5" aria-hidden="true" />
                                <p className="text-sm font-semibold">{userType.title}</p>
                              </div>
                              <Listbox.Button className="inline-flex items-center rounded-l-none rounded-r-md bg-indigo-600 p-2 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-gray-50">
                            ...
                            <Transition
                              ...
                              leaveTo="opacity-0"
                            >
                              <Listbox.Options className="absolute right-200 z-10 mt-2 w-72 origin-top-right divide-y divide-gray-200 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                {publishingOptions.map((option) => (
                                  <Listbox.Option
                                    key={option.title}
                                    className={({ active }) =>
                                      classNames(
                                        active ? 'bg-indigo-600 text-white bg-primary' : 'text-gray-900',
                                        'cursor-default select-none p-4 text-sm border-y-gray'
                                      )
                                    }
                                    value={option}
                                  >
                                    {({ selected, active }) => (
                                      <div className="flex flex-col">
                                        <div className="flex justify-between text-black font-medium">
                                          ...
                                          {selected ? (
                                            <span className={active ? 'text-white' : 'text-indigo-600 text-primary'}>
                  ...
                  <div>
                    <Listbox value={userStatus} onChange={setUserStatus}>
                      {({ open }) => (
                        <>
                          <div className="relative py-2">
                            <div className="inline-flex divide-x divide-indigo-700 rounded-md shadow-sm bg-primary">
                              <div className="inline-flex items-center gap-x-1.5 rounded-l-md bg-indigo-600 px-3 py-2 text-white shadow-sm">
                                <CheckIcon className="-ml-0.5 h-5 w-5" aria-hidden="true" />
                                <p className="text-sm font-semibold">{userStatus.title}</p>
                              </div>
                              <Listbox.Button className="inline-flex items-center rounded-l-none rounded-r-md bg-indigo-600 p-2 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-gray-50">
                                <span className="sr-only">Change published status</span>
                                <ChevronDownIcon className="h-5 w-5 text-white" aria-hidden="true" />
                            ...
                            <Transition
                              ...
                              leaveTo="opacity-0"
                            >
                              <Listbox.Options className="absolute right-30 z-10 mt-2 w-72 origin-top-right divide-y divide-gray-200 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                {publishingOptions_.map((option) => (
                                  <Listbox.Option
                                    key={option.title}
                                    className={({ active }) =>
                                      classNames(
                ...
                <div className="mb-5">
                  <input
                    ...
                    className="w-full cursor-pointer rounded-lg border border-indigo-600 bg-indigo-600 p-4 text-white transition hover:bg-opacity-90"
                  />
                </div>
